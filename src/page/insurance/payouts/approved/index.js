...
const ApprovedInsurancePayout = observer((props) => {
	const {
		InsurancePayoutsAllStore,
		ApprovedInsurancePayoutStore: {
			setPageSize,
			per_page,
		},
	} = useStore();
	...
	return (
		<>
			<PageHeader
				title={BreadcrumbConfig.ApprovedInsurancePayout.title}
				className="tableAreaSec"
				extra={<BreadcrumbComponent items={BreadcrumbConfig.ApprovedInsurancePayout.path} />}
			>
...
export default ApprovedInsurancePayout;
