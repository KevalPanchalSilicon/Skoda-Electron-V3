...
const ReceivedInsurancePayout = observer((props) => {
	const {
		InsurancePayoutsAllStore,
		ReceivedInsurancePayoutStore: {
			setPageSize,
			per_page,
		},
	} = useStore();
	...
	return (
		<>
			<PageHeader
				title={BreadcrumbConfig.ReceivedInsurancePayout.title}
				className="tableAreaSec"
				extra={<BreadcrumbComponent items={BreadcrumbConfig.ReceivedInsurancePayout.path} />}
			>
...
export default ReceivedInsurancePayout;
