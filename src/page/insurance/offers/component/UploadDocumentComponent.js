...
const UploadDocumentComponent = observer((props) => {
	...
	const handleSubmit = (data) => {
		...
		data.remarks = data.remarks ? data.remarks : null;
		fileData.append("id", selectedFile.id)
		fileData.append("ins_offer_id", InsuranceOfferStore.insurance_detail.id);
	...
	return (
		...
		>
			<Form
				form={form}
				id="insOfferUploadDocForm"
				onFinish={handleSubmit}
				labelCol={{ span: 24 }}
				onChange={handleChange}
			>
				<h2 align="middle" className="document_title">{selectedFile?.name}</h2>
