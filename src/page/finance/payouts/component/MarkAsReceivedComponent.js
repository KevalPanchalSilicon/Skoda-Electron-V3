...
const MarkAsReceivedComponent = observer((props) => {
	...
	const { PayoutsAllStore: { MarkAsReceivedData, payout_detail } } = useStore()
	...
	return (
		...
		>
			<Form form={form} layout="vertical" id="markAsReceivedForm" onFinish={handleSubmit} onChange={handleChange}>
				<Row align="middle">
					<Col span={24}>
