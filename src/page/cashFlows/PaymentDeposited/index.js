...
const PaymentsDeposited = observer((props) => {
	const {
		PaymentStore: {
			setPageSize,
			per_page,
	...
	const openConfirmModal = async (data, model, type = "get") => {
		setComponentType({ model, type, storeType: "Payment Deposited" })
	...
	return (
		<>
			<PageHeader
				title={BreadcrumbConfig.PaymentDeposited.title}
				className="tableAreaSec"
				extra={<BreadcrumbComponent items={BreadcrumbConfig.PaymentDeposited.path} />}
			>
...
export default PaymentsDeposited;
