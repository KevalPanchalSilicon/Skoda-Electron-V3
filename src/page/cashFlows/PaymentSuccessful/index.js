...
const PaymentsSuccessful = observer((props) => {
	const {
		PaymentStore: {
			setPageSize,
			per_page,
	...
	const openConfirmModal = async (data, model, type = "get") => {
		setComponentType({ model, type, storeType: "Payment Successful" })
	...
	return (
		<>
			<PageHeader
				title={BreadcrumbConfig.PaymentSuccessful.title}
				className="tableAreaSec"
				extra={<BreadcrumbComponent items={BreadcrumbConfig.PaymentSuccessful.path} />}
			>
...
export default PaymentsSuccessful;
