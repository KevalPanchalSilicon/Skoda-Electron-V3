...
const ReceivedCorporatePayout = observer((props) => {
	const {
		CorporatePayoutsAllStore,
		ReceivedCorporatePayoutStore: {
			setPageSize,
			per_page,
		},
	} = useStore();
	...
	return (
		<>
			<PageHeader
				title={BreadcrumbConfig.ReceivedCorporatePayout.title}
				className="tableAreaSec"
				extra={<BreadcrumbComponent items={BreadcrumbConfig.ReceivedCorporatePayout.path} />}
			>
...
export default ReceivedCorporatePayout;
