...
const ClaimedCorporatePayout = observer((props) => {
	const {
		CorporatePayoutsAllStore,
		ClaimedCorporatePayoutStore: {
			setPageSize,
			per_page,
		},
	} = useStore();
	...
	return (
		<>
			<PageHeader
				title={BreadcrumbConfig.ClaimedCorporatePayout.title}
				className="tableAreaSec"
				extra={<BreadcrumbComponent items={BreadcrumbConfig.ClaimedCorporatePayout.path} />}
			>
...
export default ClaimedCorporatePayout;
