...
const UnclaimedCorporatePayout = observer((props) => {
	const {
		CorporatePayoutsAllStore,
		UnclaimedCorporatePayoutStore: {
			setPageSize,
			per_page,
		},
	} = useStore();
	...
	return (
		<>
			<PageHeader
				title={BreadcrumbConfig.UnclaimedCorporatePayout.title}
				className="tableAreaSec"
				extra={<BreadcrumbComponent items={BreadcrumbConfig.UnclaimedCorporatePayout.path} />}
			>
...
export default UnclaimedCorporatePayout;
