...
const ManageVariant = observer((props) => {
	...
	return (
		<PageHeader
			title={BreadcrumbConfig.ManageVariant.title}
			className="tableAreaSec"
			extra={
				<BreadcrumbComponent items={BreadcrumbConfig.ManageVariant.path} />
			}
		>
			<div className="listCountNew">
				{AUTH.checkPrivileges("#780#") && (
