...
const ListComponent = observer((props) => {
	...
	const {
		ManageAccessoryStore: { list_data, setupGrid, onFilterChanged },
		AUTH,
	} = useStore();
	const gridOptions = {
		columnDefs: [
			...
			{
				headerName: "Accessory Type",
				field: "accessory_type.name",
				filter: "agSetColumnFilter",
			},
			{
				headerName: "Purchase Type",
				field: "purchase_type.name",
				filter: "agSetColumnFilter",
			},
			...
			{ headerName: "Part Number", field: "part_number" },
			{
				...
				cellRendererFramework: function (params) {
					return <CurrencyFormat value={params.data.mrp} />
				},
			},
			{
				headerName: "Active",
				field: "status_name",
				filter: "agSetColumnFilter",
				hide: AUTH.checkPrivileges("#715#") ? false : true,
