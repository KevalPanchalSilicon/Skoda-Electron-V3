...
export default class ManageRTOChargesStore {
	agGrid = null;
	...
	getList = () => {
		...
		this.list_data = null;
		return Axios.get(`admin/rto_charges/list`).then(({ data }) => {
	...
	// Call add api
	AddData = (formdata) => {
		return Axios.post(`admin/rto_charges/new`, formdata)
			.then(({ data }) => {
				this.getList();
				return data;
			})
	...
	// Call edit api
	EditData = (formdata) => {
		return Axios.post(`/admin/rto_charges/edit/` + formdata.id, formdata)
			.then(({ data }) => {
				this.getList();
				return data;
			})
	...
	TogglepublishData = (formdata) => {
		...
		return Axios.patch("admin/rto_charges/" + api_link + formdata.id)
			.then(({ data }) => {
				this.getList();
				return data;
			})
...
decorate(ManageRTOChargesStore, {
	per_page: observable,
	agGrid: observable,
