...
export default class ClaimedCorporatePayoutStore {
	agGrid = null;
	...
	getList = (payload) => {
		return Axios.post(`/corporate/payouts/claimed_list`, payload).then(({ data }) => {
...
decorate(ClaimedCorporatePayoutStore, {
	per_page: observable,
	agGrid: observable,
