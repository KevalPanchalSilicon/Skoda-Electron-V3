...
export default class UnclaimedCorporatePayoutStore {
	agGrid = null;
	...
	getList = (payload) => {
		return Axios.post(`/corporate/payouts/unclaimed_list`, payload).then(({ data }) => {
...
decorate(UnclaimedCorporatePayoutStore, {
	per_page: observable,
	agGrid: observable,
