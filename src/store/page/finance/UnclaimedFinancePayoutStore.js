...
export default class UnclaimedFinancePayoutStore {
	agGrid = null;
	...
	getList = (payload) => {
		return Axios.post(`/finance/payouts/unclaimed_list`, payload).then(({ data }) => {
...
decorate(UnclaimedFinancePayoutStore, {
	per_page: observable,
	agGrid: observable,
