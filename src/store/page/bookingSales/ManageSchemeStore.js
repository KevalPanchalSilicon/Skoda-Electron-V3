...
export default class ManageSchemeStore {
	agGrid = null;
	...
	getList = () => {
		...
		this.list_data = null;
		return Axios.get(`/sales/schemes/list`).then(({ data }) => {
	...
	// Call add api
	AddData = (formdata) => {
		return Axios.post(`/sales/schemes/new`, formdata)
			.then(({ data }) => {
				this.getList();
				return data;
			})
	...
	// Call edit api
	EditData = (formdata) => {
		return Axios.post(`/sales/schemes/edit/` + this.editValues.id, formdata)
			.then(({ data }) => {
				this.getList();
				return data;
			})
	...
	// Call delete api
	DeleteData = (formdata) => {
		return Axios.delete(`/sales/schemes/destroy/` + formdata.id)
			.then(({ data }) => {
				this.getList();
				return data;
			})
	...
	TogglepublishData = (formdata) => {
		...
		return Axios.patch("/sales/schemes/" + api_link + formdata.id)
			.then(({ data }) => {
				this.getList();
				return data;
			})
