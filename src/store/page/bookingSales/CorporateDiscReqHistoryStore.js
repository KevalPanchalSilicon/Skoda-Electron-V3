...
export default class CorporateDiscReqHistoryStore {
	AUTH = null
	agGrid = null;
	...
	getList = (payload) => {
		return Axios.post(`/sales/corporate_offer/history_list`, payload).then(({ data }) => {
...
decorate(CorporateDiscReqHistoryStore, {
	per_page: observable,
	agGrid: observable,
